    ...
    <div className={`space-y-3 ${className}`}>
      ...
      {mode === 'url' && (
        <input
          ...
          className="w-full rounded-lg bg-gray-50 border border-brandSteel/50 px-3 py-2 text-gray-900 focus:ring-2 focus:ring-brandGreen/50 focus:border-brandGreen focus:outline-none shadow-sm"
        />
      )}
      ...
      {mode === 'upload' && (
        <div className="space-y-2">
          <input
            ...
            disabled={uploading}
            className="w-full rounded-lg bg-gray-50 border border-brandSteel/50 px-3 py-2 text-gray-900 file:mr-4 file:py-1 file:px-2 file:rounded-md file:border-0 file:text-sm file:bg-brandGreen file:text-white hover:file:bg-brandGreen/90 disabled:opacity-50 disabled:cursor-not-allowed focus:ring-2 focus:ring-brandGreen/50 focus:border-brandGreen shadow-sm"
          />
