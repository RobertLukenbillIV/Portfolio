    ...
    <div className={`space-y-3 ${className}`}>
      ...
      {mode === 'url' && (
        <input
          ...
          className="w-full rounded-lg bg-slate-100 border-2 border-slate-300 px-3 py-2 text-gray-900 focus:ring-2 focus:ring-brandGreen focus:border-brandGreen focus:outline-none shadow-md"
        />
      )}
      ...
      {mode === 'upload' && (
        <div className="space-y-2">
          <input
            ...
            disabled={uploading}
            className="w-full rounded-lg bg-slate-100 border-2 border-slate-300 px-3 py-2 text-gray-900 file:mr-4 file:py-1 file:px-2 file:rounded-md file:border-0 file:text-sm file:bg-brandGreen file:text-white hover:file:bg-brandGreen/90 disabled:opacity-50 disabled:cursor-not-allowed focus:ring-2 focus:ring-brandGreen focus:border-brandGreen shadow-md"
          />
