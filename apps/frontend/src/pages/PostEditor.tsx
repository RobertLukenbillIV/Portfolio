  ...
  return (
    <div className="mx-auto max-w-4xl p-6">
      ...
      <textarea
        ...
        rows={2}
        className="w-full mb-3 rounded-lg bg-white border border-brandSteel/50 px-3 py-2 text-gray-900 resize-y focus:ring-2 focus:ring-brandGreen/50 focus:border-brandGreen"
